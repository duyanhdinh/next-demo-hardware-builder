    ...
    return (
        <>
            ...
            <div className="w-full flex">
                <div className="w-1/3"><span className="font-semibold">Screen Size:</span> {info.screen_size + '"'}</div>
                <div className="w-1/3 text-center"><span className="font-semibold">Resolution:</span> {info.resolution}</div>
                <div className="w-1/3 text-right"><span className="font-semibold">Aspect Ratio:</span> {info.aspect_ratio}</div>
            </div>
            <div className="w-full flex">
                <div className="w-1/3"><span className="font-semibold">Response Time:</span> {info.response_time_ms} ms</div>
                <div className="w-1/3 text-center"><span className="font-semibold">Panel Type:</span> {info.panel}</div>
                <div className="w-1/3 text-right"><span className="font-semibold">Refresh Rate:</span> {info.refresh_rate} Hz</div>
            </div>
        </>
    )
}
