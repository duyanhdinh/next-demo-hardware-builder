    ...
    return (
        <>
            <div className="w-full flex flex-wrap">
                ...
                <div className="w-full lg:w-1/3 text-left lg:text-center"><span className="font-semibold">Form Factor:</span> {info.form_factor}</div>
                <div className="w-full lg:w-1/3 text-left lg:text-right"><span className="font-semibold">Socket Type:</span> {info.socket_type}</div>
                <div className="w-full lg:w-1/2"><span className="font-semibold">Memory Slots:</span> {info.memory_slots} Slots</div>
                <div className="w-full lg:w-1/2 text-left lg:text-right"><span className="font-semibold">Max Memory Support:</span> {info.max_memory_gb} GB</div>
            </div>
        </>
    )
}
